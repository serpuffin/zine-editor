...
A free-form canvas web application for creating and editing zines with professional-quality templates.
...
1. Select a page size from the dropdown
2. Add text or images using the toolbar
3. Edit and arrange elements on the canvas
